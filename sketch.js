...
function setup() {
  ...
  block17 = new Block(620,155,30,40);
  //level two
  ...
  //level three
  block23 = new Block(650,140,30,40);
  block24 = new Block(680,140,30,40);
  block25 = new Block(710,140,30,40);
  //top
  block26 = new Block(740,140,30,40);

  block27 = new Block(680,90,30,40);
  //level two
  block28 = new Block(710,90,30,40);
  block29 = new Block(715,60,30,40);
  block30 = new Block(800,100,30,40);
  block31 = new Block(770,90,30,40);
  block32 = new Block(740,80,30,40);
